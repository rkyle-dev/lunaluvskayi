...
const jarMemories = [
  ...
  { text:"Nakapag saing ako ng walang tubig dahil busy ako kausap ka joskoh", tag:"Tanga" },
  { text:"Hinatidan kita ng ice cream sa bahay niyo naligaw ligaw ako ah nagtatanong nako sa bata", tag:"Para sa ice cream mo" },
  { text:"Inaya mo ako kumain sa labas ng fried noodles tas pag uwi wala ka manlang nilagay na kahit ano sauce, gusto mo lang pala ako ayain", tag:"Crush niya ako, huy bff tayo" },
  { text:"Nag watch together tayo dalawang oras ung movie tapos 2 years bago ko nalaman na buong time na yon wala ka palang sound naririnig sinasabayan mo lang ako", tag:"Nakakahiya moments" },
